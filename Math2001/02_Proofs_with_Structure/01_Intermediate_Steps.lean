...
example (a b : ℝ) (h1 : -b ≤ a) (h2 : a ≤ b) : a ^ 2 ≤ b ^ 2 := by
  ...
  have h4 : a + b ≥ 0 := by addarith[h1]
  calc
    a ^ 2 ≤ a ^ 2 + (a + b) * (b - a) := by extra -- This works bc h3 and h4 >= 0
...
example (a b : ℝ) (h : a ≤ b) : a ^ 3 ≤ b ^ 3 := by
  ...
  calc
    ...
    _ = b ^ 3 := by ring --TODO: COME BACK TO AND UNDERSTAND ALGEBRA ^^^
